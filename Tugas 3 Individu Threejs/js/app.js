...
const light1 = scene.add(new THREE.PointLight(0xfcba03, 1));
// light1.position.set(-25, 50, -25);
light1.position.x = -25;
light1.position.y = 50;
light1.position.z = -25;
const light2 = scene.add(new THREE.PointLight(0xc300ff, 1));
// light2.position.set(25, 50, -25);
light2.position.x = 25;
light2.position.y = 50;
light2.position.z = -25;
const light4 = scene.add(new THREE.PointLight(0xfcba03, 1));
// light1.position.set(-25, 50, -25);
light4.position.x = -25;
light4.position.y = 50;
light4.position.z = 25;
const light5 = scene.add(new THREE.PointLight(0xc300ff, 1));
// light2.position.set(25, 50, -25);
light5.position.x = 25;
light5.position.y = 50;
light5.position.z = 25;

const light3 = scene.add(new THREE.AmbientLight(0xc300ff, 100));
